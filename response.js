...
export default class Response {
    ...
    JSON(jsonObj, ETag = "", fromCache = false) {                         // ok status with content
        ...
        if (jsonObj != null) {
            ...
            if (!fromCache && this.HttpContext.path.isAPI && !this.HttpContext.path.id) {
        ...
        // else if (fromCache && this.HttpContext.path.isAPI && this.HttpContext.path.id){
        //     return this.end(CachedRequestsManager.find(this.req.url));
        // }
        // if (jsonObj != null) {
        //     let content = JSON.stringify(jsonObj);
        //     return this.end(content);
